...
{   
    /**
     *
     * @var \FurryBear\Iterator\SunlightCongress\PageIterator
     */
    protected $iterator;
    ...
    protected function setUp()
    {
        ...
        $provider = new \FurryBear\Provider\Source\SunlightCongress($adapter, 'some-api-key');
        ...
        $this->iterator = new \FurryBear\Iterator\SunlightCongress\PageIterator($resource);
    }
