...
/**
 * A test for SunlightFoundation\Committees.
 * 
 * @category Congress_API
 * @package  FurryBear
 * @author   lobostome <lobostome@local.dev>
...
class CommitteesTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    /**
     * @var \FurryBear\Resource\SunlightFoundation\Committees
     */
    ...
    protected function setUp()
    {
        ...
        $this->committees = new \FurryBear\Resource\SunlightFoundation\Committees($this->furryBear);
    }
    ...
    public function testConstruct()
    {
        ...
        $this->assertAttributeEquals(\FurryBear\Resource\SunlightFoundation\Committees::COMMITTEES_METHOD, 'resourceMethod', $this->committees);
    }
}