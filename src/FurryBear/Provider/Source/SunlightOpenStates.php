...
/**
 * A concrete provider based on Sunlight Foundation Open States API.
 * 
 * @category Congress_API
 * @package  FurryBear
 * @author   lobostome <lobostome@local.dev>
 ...
 */
class SunlightOpenStates extends AbstractProvider
{
    /**
     ...
     */
    const RESOURCE_DIR = 'SunlightOpenStates';
