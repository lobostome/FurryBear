...
/**
 * A concrete provider based on Sunlight Political Party Time API.
 * 
 * @category Congress_API
 * @package  FurryBear
 * @author   lobostome <lobostome@local.dev>
 ...
 */
class SunlightPoliticalPartyTime extends AbstractProvider
{
    /**
     * The domain of the API.
     */
    const SERVICE_URL = 'http://politicalpartytime.org/api/v1';
    
    /**
     * The resource directory.
     */
    const RESOURCE_DIR = 'SunlightPoliticalPartyTime';
