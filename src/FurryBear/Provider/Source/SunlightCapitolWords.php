...
/**
 * A concrete provider based on Sunlight Foundation Capitol Words API.
 * 
 * @category Congress_API
 * @package  FurryBear
 * @author   lobostome <lobostome@local.dev>
 ...
 */
class SunlightCapitolWords extends AbstractProvider
{
    /**
     * The domain of the API.
     */
    const SERVICE_URL = 'http://capitolwords.org/api/1';
    
    /**
     * The resource directory.
     */
    const RESOURCE_DIR = 'SunlightCapitolWords';
