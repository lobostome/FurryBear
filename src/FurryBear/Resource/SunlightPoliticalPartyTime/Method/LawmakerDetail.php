...
/**
 * This class gives access to Sunlight Political Party Time lawmaker detail resource.
 * 
 * @category Congress_API
 * @package  FurryBear
 * @author   lobostome <lobostome@local.dev>
 ...
 * @link     https://github.com/lobostome/FurryBear
 */
class LawmakerDetail extends BaseResource
{
    /**
    ...
    /**
     * Sets the id of the lawmaker.
     * 
     * @param int $id The lawmaker id.
     * 
     * @return \FurryBear\Resource\SunlightPoliticalPartyTime\Method\LawmakerDetail
     */
