...
/**
 * This class gives access to Sunlight Political Party Time hosts detail resource.
 * 
 * @category Congress_API
 * @package  FurryBear
 * @author   lobostome <lobostome@local.dev>
...
class HostDetail extends BaseResource
{
     ...
     * 
     * @return \FurryBear\Resource\SunlightPoliticalPartyTime\Method\HostDetail
     */
