...
/**
 * This class gives access to Sunlight Open States events detail resource.
 * 
 * @category Congress_API
 * @package  FurryBear
 * @author   lobostome <lobostome@local.dev>
...
class EventDetail extends BaseResource
{
     ...
     * 
     * @return \FurryBear\Resource\SunlightOpenStates\Method\EventDetail
     */
