...
/**
 * This class gives access to Sunlight Open States legislators detail resource.
 * 
 * @category Congress_API
 * @package  FurryBear
 * @author   lobostome <lobostome@local.dev>
 ...
 * @link     https://github.com/lobostome/FurryBear
 */
class LegislatorDetail extends BaseResource
{
    /**
    ...
    /**
     * Sets the id of the legislator.
     * 
     * @param string $id The legislator id.
     * 
     * @return \FurryBear\Resource\SunlightOpenStates\Method\LegislatorDetail
     */
